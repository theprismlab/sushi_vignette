...
Although collaborators are not able to run this module on their own data, they are able to see how metrics are calculated.
...
Here is an example of how to run the multivariate biomarker function on your data. Inputs are the same those for the univariate biomarker function.
